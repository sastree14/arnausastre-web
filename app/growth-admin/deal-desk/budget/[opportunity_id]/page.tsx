...
export default async function BudgetDocumentPage({ params }: { params: Promise<{ opportunity_id: string }> }) {
  ...
  const pricingNotes = text(budget.pricing_notes)
