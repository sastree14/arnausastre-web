...
export const METRIC_CATALOG:MetricDefinition[]=[
  ...
  {group:'Website',metric:'Usuarios',source:'Google Analytics 4',storage:'web_analytics_daily',formula:'SUM/users según snapshots sincronizados',mode:'scheduled',refresh:'Cron diario + botón Sincronizar Google',zeroMeaning:'0 real solo si existe una sync para el periodo; sin sync significa sin datos'},
  {group:'Website',metric:'Sesiones',source:'Google Analytics 4',storage:'web_analytics_daily',formula:'SUM(sessions)',mode:'scheduled',refresh:'Cron diario + manual',zeroMeaning:'Igual que Usuarios'},
  {group:'Website',metric:'Engagement web',source:'Google Analytics 4',storage:'web_analytics_daily',formula:'engaged_sessions / sessions',mode:'scheduled',refresh:'Cron diario + manual',zeroMeaning:'0% si hay sesiones sin engaged sessions; — si no hay sesiones'},
  {group:'Website',metric:'Discovery intent',source:'GA4 events',storage:'web_analytics_daily',formula:'SUM(discovery_clicks)',mode:'scheduled',refresh:'Cron diario + manual',zeroMeaning:'0 eventos en datos sincronizados'},
  {group:'Website',metric:'Bookings',source:'GA4/Calendly attribution',storage:'web_analytics_daily',formula:'SUM(bookings)',mode:'scheduled',refresh:'Cron diario + manual',zeroMeaning:'0 bookings atribuidos en datos sincronizados'},
  ...
  {group:'LinkedIn',metric:'Impressions',source:'Export oficial LinkedIn',storage:'linkedin_post_metrics',formula:'SUM de último snapshot por post',mode:'manual_import',refresh:'Al importar XLS/XLSX oficial',zeroMeaning:'0 solo si un import contiene 0; sin import = sin datos'},
  {group:'LinkedIn',metric:'Reach',source:'Export oficial LinkedIn',storage:'linkedin_post_metrics',formula:'SUM de último snapshot por post',mode:'manual_import',refresh:'Import XLS/XLSX',zeroMeaning:'Sin import no se interpreta como 0 real'},
  {group:'LinkedIn',metric:'Engagement',source:'Export oficial LinkedIn',storage:'linkedin_post_metrics',formula:'(reactions + comments + reposts + saves + clicks) / (reach o impressions)',mode:'manual_import',refresh:'Import XLS/XLSX',zeroMeaning:'— si no hay denominador'},
  {group:'LinkedIn',metric:'Followers gained',source:'Export oficial LinkedIn',storage:'linkedin_post_metrics',formula:'SUM(followers_gained)',mode:'manual_import',refresh:'Import XLS/XLSX',zeroMeaning:'Sin import = sin datos, no 0 confirmado'},
